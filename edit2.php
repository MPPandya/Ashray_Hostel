...
$sql = 'SELECT * FROM booking_localgaurdian WHERE user_id=:id';
...
if (isset ($_POST['lgname'])  )
{
  
$lgname=         $_POST['lgname'];
$lgaddress=      $_POST['lgaddress'];
$lgrelationship=   $_POST['lgrelationship'];
$lgmobile=     $_POST['lgmobile'];
$lgemail=        $_POST['lgemail'];

  $sql = 'UPDATE booking_localgaurdian SET LG_name=:lgname,LG_address=:lgaddress,LG_relationship=:lgrelationship,LG_mobile=:lgmobile,LG_email=:lgemail WHERE user_id=:id';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':lgname' => $lgname,':lgaddress' => $lgaddress,':lgrelationship' => $lgrelationship,':lgmobile'=>$lgmobile,':lgemail' => $lgemail,':id' => $id])) {
...
<div class="container">
  <div class="card mt-5">
    <div class="card-header">
      <h2>Update Local Gaurdian Details</h2>
    </div>
    <div class="card-body">
      ...
      <form  method="post">
        <div class="form-group">
          ...
          <input value="<?= $person->LG_name; ?>" type="text" name="lgname"  class="form-control">
        </div>
		<div class="form-group">
          <label for="lgaddress">Address</label>
          <input value="<?= $person->LG_address; ?>" type="text" name="lgaddress"  class="form-control">
        </div>
		
		 <div class="form-group">
          <label for="lgmobile">Mobile No</label>
          <input value="<?= $person->LG_mobile; ?>" type="number" name="lgmobile"  class="form-control">
        </div>
		<div class="form-group">
          <label for="lgemail">Email Id</label>
          <input value="<?= $person->LG_email; ?>" type="text" name="lgemail"  class="form-control">
        </div>
		
		<div class="form-group">
          <label for="lgrelationship">relationship</label>
          <input value="<?= $person->LG_relationship; ?>" type="text" name="lgrelationship"  class="form-control">
        </div>
